...
@Autonomous(name="Red Carousel Side New",group="New Autons")
public class Red_Carousel extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        r.AEncDrive(20,-38,dPower,2500); // Strafe over to wall
        ...
        r.AEncDrive(-14,0,0.15,3000); // Back into spinner
       ...
       // r.setSpin(0);
        ...
        r.AEncDriveLinearSlow(0,64,dPower,4500);
